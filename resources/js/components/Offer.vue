            ...
            <v-container fluid class="px-10 py-10">
                <form @submit.prevent="authenticate">
                    ...
                    <p>Sehubung dengan diskusi pada <span><input v-model="documentData.discussion_date" type="text" id="InputEmail" required></span> yang
                            ...
                            Aplikasi Survei Sebersar Rp. <span><input v-model="documentData.offerprice" type="text" id="InputEmail" required></span>
                            ,- (<span><input v-model="documentData.offerpricename" type="text" id="InputEmail" required></span>). </p>
                        ...
                        <p>Kami akan melaksanakan pekerjaan tersebut dengan jangka waktu pelaksanaan pekerjaan selama
                            <span><input v-model="documentData.duration" type="text" id="InputEmail" required></span> (<span><input v-model="documentData.durationname" type="text"
                                    id="InputEmail" required></span>) hari kerja.</p>
                        <p>Penawaran ini berlaku selama <span><input v-model="documentData.offerduetime" type="text" id="InputEmail" required></span>
                            (<span><input v-model="documentData.offerduetimename" type="text" id="InputEmail" required></span>) hari kalender sejak tanggal
                            surat penawaran ini.
                            surat penawaran beserta lampirannya kami sampaikan sebanyak <span><input v-model="documentData.attachment" type="text"
                                    id="InputEmail" required></span> (<span><input v-model="documentData.attachmentname" type="text" id="InputEmail"

                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" style="text-align: center;">
                                ...
                                <tbody style="border: 1px solid #000;">
                                    <tr style="font-size: 14px; text-align: left;">
                                        <td style="width: 5%; padding: 5px 5px 1px 20px; border: 2px solid #2496b8;">
                                            <span style="display: block;">
                                                1
                                            </span>
                                        </td>
                                        <td style="width: 50%; padding: 5px 5px 1px; border: 2px solid #2496b8;">
                                            <span style="display: block;">
                                        ...
                                        <td style="width: 20%; padding: 5px 5px 1px; border: 2px solid #2496b8;">
                                            <span style="display: block;">
                                                Rp 13,204,000
                                            </span>
                                        </td>
